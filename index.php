        ...
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <div class="nav__btns">
                    ...
                    <div class="nav__shop"    data-bs-toggle="modal" data-bs-target="#cartModal" style="font-family:sans-serif; font-size:20px; font-weight:500;" >
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    <div class="modal fade" id="cartModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <footer class="footer section">
            ...
            <span class="footer__copy">&#169; MyProject. All rigths reserved</span>
        </footer>
